...
function Project() {
  return (
    <div> <h className='flex justify-center bg-gray-800 text-white font-bold text-xl'>Projects</h>
      <div className='flex gap-8 p-7  justify-center bg-slate-500 font-semibold items-center'>

        <div className='bg-black w-96  h-96 rounded-3xl flex  justify-center   '>
          <div className='text-white '> Instagaram (Clone)
        ...
        <div className='bg-black w-96 px-2 h-96 rounded-3xl flex justify-center'>
          <div className='text-white'>Marvel Ui/Ux
        ...
        <div className='bg-black w-96 px-2 h-96 rounded-3xl flex justify-center'>
          <div className='text-white'> Whatsapp(Clone)
